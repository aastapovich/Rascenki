"""Compatibility shim: re-export App from `ui.ui_tk`.

Keeps `from ui_tk import App` working while canonical implementation
was moved to `ui/ui_tk.py`.
"""
from ui.ui_tk import *  # noqa: F401,F403
